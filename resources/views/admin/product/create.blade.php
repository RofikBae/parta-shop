      ...
      <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="form-group row {{ $errors->has('name') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-10">
              <input name="name" type="text" class="form-control form-control-sm" value="{{ old('name') }}" placeholder="">
              @if ($errors->has('name'))
                  <p class="help-block">
                    {{$errors->first('name')}}
                  </p>
          ...
          <div class="form-group row {{ $errors->has('price') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-10">
              <input name="price" type="text" class="form-control form-control-sm" value="{{ old('price') }}" placeholder="">
              @if ($errors->has('price'))
                  <p class="help-block">
                    {{$errors->first('price')}}
                  </p>
